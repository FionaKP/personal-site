...
const projects: Project[] = [
  {
    title: "Blueleaf Mobile Client App",
    description: "Rebuilt a production mobile application for financial advisors from the ground up using React Native, delivering a cross-platform experience on iOS and Android with redesigned interfaces informed by direct client feedback.",
    extendedDescription: "Took ownership of a full rebuild of Blueleaf's mobile advisor application using React Native, replacing the existing codebase with a modernized architecture that runs natively on both iOS and Android. The project spanned the entire development lifecycle — from setting up the build environment and configuring platform-specific identifiers across Xcode and Android, to implementing updated UI components and shipping the final product. Conducted live interviews with financial advisor clients to identify pain points in how they interacted with portfolio data, large-scale reporting, and day-to-day account management. Feedback from those conversations directly shaped interface decisions and feature priorities throughout the build. The result was a cleaner, more usable mobile experience designed around how advisors actually work with their clients' data.",
    tags: ["Mobile App", "React Native", "Full Stack"],
    status: "Live",
    emoji: "📱",
    image: "/projects/blueleaf_graph.png",
    images: ["/projects/blueleaf_home.png", "/projects/blueleaf_holdings.png", "/projects/blueleaf_notifications.png"],
    websiteUrl: "https://www.blueleaf.com/reporting/client-mobile-app/",
  },
  {
    ...
    status: "Live",
    emoji: "🔍",
    image: "/projects/jobflow_kanban.png",
    images: ["/projects/jobflow_details.png", "/projects/jobflow_popup.png", "/projects/jobflow_connections.png"],
    websiteUrl: "https://chromewebstore.google.com/detail/bcohcpbdbhpmamckpjoijefabfcnnmkc?utm_source=item-share-cb",
    githubUrl: "https://github.com/FionaKP/job-search-extension",
  },
  {
